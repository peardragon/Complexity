...
Scale: one split, 4 label rules, 60 exact references per rule, selected all-pass hard d_raw line [0.01, 0.011, 0.012, 0.013, 0.014].
...
Sampling rows: 1200 unit summaries. Baseline sample-count mix: {4096: 570}. Fallback total-sample mix: {16384: 503, 32768: 57, 65536: 70}.
...
| --- | --- | --- | --- |
| low_tv_spectral_teacher | 5 | 5 | 0.0100..0.0140 |
| real_even_odd | 5 | 5 | 0.0100..0.0140 |
| teacher_nn | 5 | 5 | 0.0100..0.0140 |
| random_label | 5 | 5 | 0.0100..0.0140 |

Common supported radii across all rules: 5 / 5.

## Phi Outputs

| scope | file | rows | claim status |
| --- | --- | --- | --- |
| raw all-pass line diagnostic | phi_by_rule_radius_raw_diagnostic.csv | 20 | same rows as selected line |
| QC-pass rule/radius | phi_by_rule_radius.csv | 20 | all selected rows claimable |
| common-radius claim table | final_claim_table.csv | 5 | 5 supported, 0 no_claim |
...
| raw selected-line energy | figures/fig08_phi_energy_raw_dense_diagnostic.png | all rules, 5 radii each |
| raw selected-line full | figures/fig09_phi_full_raw_dense_diagnostic.png | all rules, 5 radii each |
...
The selected phi(d) curves were obtained for all four rules over 5 hard radii. Since every selected rule/radius row passed QC, the energy curve is the formal all-pass claim line rather than a no-claim diagnostic subset.
