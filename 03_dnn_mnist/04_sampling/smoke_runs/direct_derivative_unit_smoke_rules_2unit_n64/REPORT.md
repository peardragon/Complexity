...
- Radius grid: `custom_2_radii`
- Radii: `0.1..0.2` (2 values)
- Samples per unit: `64`
- QC diagnostic pass rows: `2` / `8`

| rule | complete_radii | observed_units | missing_units | qc_diagnostic_pass_radii |
| --- | --- | --- | --- | --- |
| random_label | 0 | 0 | 2 | 0 |
| real_even_odd | 0 | 0 | 2 | 0 |
| teacher_nn | 0 | 0 | 2 | 0 |
| very_low_tv_spectral_teacher | 2 | 2 | 0 | 2 |
