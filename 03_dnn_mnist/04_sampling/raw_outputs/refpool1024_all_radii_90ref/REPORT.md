...
- Radius grid: `mechanical_0p1_to_2p5_step0p1`
- Radii: `0.1..2.5` (25 values)
- Samples per unit: `1024`
- QC diagnostic pass rows: `5` / `100`

| rule | complete_radii | observed_units | missing_units | qc_diagnostic_pass_radii |
| --- | --- | --- | --- | --- |
| low_tv_spectral_teacher | 25 | 2250 | 0 | 2 |
| random_label | 25 | 2250 | 0 | 0 |
| real_even_odd | 25 | 2250 | 0 | 2 |
| teacher_nn | 25 | 2250 | 0 | 1 |
