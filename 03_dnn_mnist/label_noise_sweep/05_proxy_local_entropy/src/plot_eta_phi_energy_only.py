...
OUT_NAME = "eta_phi_energy_dense30ref_r1p0_n1024_cpu60_gpu0_eta0p02_0p05_0p15_0p25"
...
def main() -> int:
    ...
    units[["eta", "ref_id", "radius", "phi_energy_raw"]].sort_values(["eta", "ref_id", "radius"]).to_csv(
        args.summary_dir / "eta_phi_energy_by_ref_radius.csv", index=False
    )
    summary.to_csv(args.summary_dir / "eta_phi_energy_by_eta_radius.csv", index=False)
