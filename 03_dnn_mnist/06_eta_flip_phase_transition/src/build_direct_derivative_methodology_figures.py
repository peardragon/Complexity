...
def main() -> int:
    ...
    units.to_csv(out_dir / "combined_direct_derivative_units.csv", index=False)
    summary.to_csv(out_dir / "combined_direct_phi_by_group_radius.csv", index=False)
    curves.to_csv(out_dir / "combined_direct_curvature_by_ref_radius.csv", index=False)
    ref_metrics.to_csv(out_dir / "combined_direct_curvature_metrics_by_ref.csv", index=False)
    metric_summary.to_csv(out_dir / "combined_direct_curvature_metrics_by_group.csv", index=False)
    curve_summary.to_csv(out_dir / "combined_direct_curvature_curve_by_group_radius.csv", index=False)
    if not case_metrics.empty:
        case_metrics.to_csv(out_dir / "combined_direct_dataset_complexity_metrics.csv", index=False)
    ...
    write_report(out_dir, fig_paths, status)
