...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build MNIST manual-rule dataset payloads from a stage-local original MNIST cache.")
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Regenerate rule dataset.npz payloads from raw_outputs/original_mnist.",
    )
    parser.add_argument(
        "--source-cache",
        default=None,
