...
The 3NN final is sourced from the old final export rooted at
...
- `d_0.01_to_2.50_sparse`

Reference search also keeps the 30/30 future run:
`02_dnn/03_reference_search/raw_outputs/36_beta_cell_30_dataset_30_reference/`.
