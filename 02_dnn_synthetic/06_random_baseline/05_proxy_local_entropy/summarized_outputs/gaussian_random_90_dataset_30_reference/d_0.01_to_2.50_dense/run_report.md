# Proxy local entropy raw_outputs report: d_0.01_to_2.50_dense

이 폴더는 05_proxy_local_entropy figure를 재현하기 위한 proxy summary table을 보관한다.

## Config

- input unit summaries: `02_dnn_synthetic/06_random_baseline/04_sampling/raw_outputs/shell_pool/dataset_*/ref_*/r_*/unit_summary.json`
- input samples: `02_dnn_synthetic/06_random_baseline/04_sampling/raw_outputs/shell_pool/dataset_*/ref_*/r_*/samples.npz`
...
`04_sampling/raw_outputs/shell_pool/dataset_*/ref_*/r_*/`를 입력으로 이 폴더의 proxy summary tables를 만들고, `05_proxy_local_entropy/figures/`의 local entropy, derivative, phase-map figure가 이 table들을 사용한다.
